...
<html>
    ...
    <body>
        <table style="width: 700px">
                ...
                <table style="width: 95%" cellpadding="5" cellspacing="5" bgcolor="#f7f4f4">
                    ...
                    @endforeach
                        <tr>
                            ...
                            <td>NGN {{ $orderDetails['shipping_charges'] }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>NGN {{ $orderDetails['grand_total'] }}</td>
                        </tr>
                </table>    
            </td></tr>
            <tr><td>&nbsp;</td></tr>
            ...
            <tr><td>&nbsp;</td></tr>
            <tr><td>For any queries, you can contact us at <a href="mailto:craftia@craftia.com.ng">craftia@craftia.com.ng</a></td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td>Regards,<br>Team Craftia</td></tr>
            <tr><td>&nbsp;</td></tr>
        </table>
    </body>
</html>