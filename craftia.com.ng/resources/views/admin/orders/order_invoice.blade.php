    						...
    						<tbody>
                                ...
                                @foreach ($orderDetails['orders_products'] as $product)
                                    <tr>
                                        ...
                                        <td class="text-center">NGN {{ $product['product_price'] }}</td>
                                        <td class="text-center">{{ $product['product_qty'] }}</td>
                                        <td class="text-right">NGN {{ $product['product_price'] * $product['product_qty'] }}</td>
                                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="thick-line text-right">NGN {{ $subTotal }}</td>
                                </tr>
                                <tr>
                                    <td class="no-line"></td>
                                    <td class="no-line"></td>
                                    ...
                                    <td class="no-line text-right">NGN 7000</td>
                                </tr>
                                <tr>
                                    <td class="no-line"></td>
                                    <td class="no-line"></td>
                                    ...
                                    <td class="no-line text-right">
                                        <strong>NGN {{ $orderDetails['grand_total'] }}</strong>
                                        <br>
