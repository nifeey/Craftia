            ...
            <div class="row">
                <div class="col-lg-12" align="center">
                    ...
                    <form action="{{ route('payment') }}" method="post"> {{-- This is a Named Route. Check web.php --}} {{-- Generating URLs To Named Routes: https://laravel.com/docs/9.x/routing#generating-urls-to-named-routes --}}
                        ...
                        <input type="hidden" name="amount" value="{{ round(Session::get('grand_total') / 1700, 2) }}"> {{-- 'grand_total' was stored in Session in checkout() method in Front/ProductsController.php --}} {{-- Interacting With The Session: Retrieving Data: https://laravel.com/docs/9.x/session#retrieving-data --}} {{-- Note: PayPal accepts world major currencies ONLY, so we divided NGN by 1700 to convert NGN to USD --}}
