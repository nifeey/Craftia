       ...
       $shipping_charges=0;
        ...
        foreach ($deliveryAddresses as $key => $value) {
            ...
            if (isset($data['address_id'])) {
                $selectedAddress = DeliveryAddress::find($data['address_id']);
               
                
                $shipping_charges = ShippingCharge::getShippingCharges($total_weight, $selectedAddress->country);
            } else {
                $shipping_charges = 0; // Default to 0 if no address is selected
            }
        ...
        return view('front.products.checkout')->with(compact('deliveryAddresses','shipping_charges', 'countries', 'getCartItems', 'total_price'));
    }
