        ...
        $invoiceHTML = '
            ...
            <body>
                <header class="clearfix">
                    <div class="container">
                    <div>
                    <h2 class="title">Craftia</h2>
                    </div>
                        <div class="company-address">
                            <p>
                                Lincol campus, Along jikwoyi-karshi road Azhata, Kurudu, Federal Capital Territory
                            </p>
                        </div>
                        <div class="company-contact">
                            ...
                            <div class="email right">
                                ...
                                <a href="mailto:craftia@craftia.com.ng">craftia@craftia.com.ng</a>
                                <span class="helper"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="details clearfix">
                            ...
                            <div class="data right">
                                ...
                                <div class="date">
                                    ...
                                    Order Amount: NGN ' . $orderDetails['grand_total'] . '<br>
                            ...
                            foreach ($orderDetails['orders_products'] as $product) {
                                ...
                                $invoiceHTML .= '
                                    <tr>
                                        ...
                                        <td class="unit">NGN ' . $product['product_price'] . '</td>
                                        <td class="total">NGN ' . $product['product_price'] * $product['product_qty'] . '</td>
                                    </tr>';
                            ...
                            <table class="grand-total">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="total">NGN ' . $subTotal . '</td>
                                    </tr>
                                    <tr>
                                        <td class="desc"></td>
                                        <td class="desc"></td>
                                    ...
                                    <tr>
                                        ...
                                        if ($orderDetails['coupon_amount'] > 0) {
                                            // We CONCATENATE $invoiceHTML
                                            $invoiceHTML .= '<td class="total">NGN '. $orderDetails['coupon_amount'] . '</td>';
                                        } else {
                                            // We CONCATENATE $invoiceHTML
                                            $invoiceHTML .= '<td class="total">NGN 0</td>';
                                        }
                                    ...
                                    <tr>
                                        ...
                                        <td class="total">NGN ' . $orderDetails['grand_total'] . '</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
