...
class IndexController extends Controller
{
    public function index() {
        ...
        $meta_title       = 'Craftia- Global marketplace for customized, handmade and unique products';
        $meta_description = 'Online Shopping Website which deals in Customized, Handmade & Unique Products';
