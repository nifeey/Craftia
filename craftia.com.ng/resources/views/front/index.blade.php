    ...
    <div class=" ph-item">
        <div class="slider-main owl-carousel" >
            ...
            {{-- Show the banner dynamically depending on the Admin Panel choice --}} 
                ...
                <div class="bg-image" >
                    <div class="slide-content" style="background:url('{{asset('front/images/banner_images/cratia_hero.jpg')}} '); height: 80%; backdrop-filter: brightness(40%);" >
                        <h1>Craftia</h1>
                    </div>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="item-content">
                                                <div class="what-product-is">
                                                    ...
                                                    <h6 class="item-title">
                                                        <a href="{{ url('product/' . $product['id']) }}">NGN {{ $product['product_price'] }}</a>
                                                    </h6>
