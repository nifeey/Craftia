                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a title="View Order Details" href="{{ url('admin/orders/' . $order['id']) }}">
                                                            <i style="font-size: 25px; color: #C0173E;" class="mdi mdi-file-document"></i> 
                                                        </a>
                                                        &nbsp;&nbsp;

                                                        {{-- View HTML invoice --}} 
                                                        <a title="View Order Invoice" href="{{ url('admin/orders/invoice/' . $order['id']) }}" target="_blank">
                                                            <i style="font-size: 25px; color: #C0173E;" class="mdi mdi-printer"></i> 
                                                        </a>
                                                        &nbsp;&nbsp;

                                                        {{-- View PDF invoice --}} 
                                                        <a title="Print PDF Invoice" href="{{ url('admin/orders/invoice/pdf/' . $order['id']) }}" target="_blank">
                                                            <i style="font-size: 25px; color: #C0173E;" class="mdi mdi-file-pdf"></i> 
                                                        </a>
                                                    </td>
                                                </tr>
                                            @endif
