                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <form name="checkoutForm" id="checkoutForm" action="{{ url('/checkout') }}" method="post" style="margin-bottom: 10px">
                                    ...
                                    <div class="order-table">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($getCartItems as $item) {{-- $getCartItems is passed in from cart() method in Front/ProductsController.php --}}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h6 class="order-h6">NGN{{ $getDiscountAttributePrice['final_price'] * $item['quantity'] }}</h6> {{-- price of all products (after discount (if any)) (= price (after discoutn) * no. of products) --}}
                                                        </td>
                                                    </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h3 class="order-h3">NGN{{ $total_price }}</h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <h6 class="order-h6">
                                                            <strong class="shipping_charges" id="shippingCharges{{ $address['id'] ?? 0}}">NGN{{ $address['shipping_charges'] ?? 0 }}</strong>
                                                        </h6>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="order-h6">
                                                            ...
                                                            @if (\Illuminate\Support\Facades\Session::has('couponAmount')) {{-- We stored the 'couponAmount' in a Session Variable inside the applyCoupon() method in Front/ProductsController.php --}}
                                                                <span class="couponAmount">NGN{{ \Illuminate\Support\Facades\Session::get('couponAmount') }}</span>
                                                            @else
                                                                NGN0
                                                            @endif
                                                        </h6>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h3 class="order-h3">
                                                            <strong class="grand_total">NGN{{ $total_price +( $address['shipping_charges'] ?? 0) - \Illuminate\Support\Facades\Session::get('couponAmount', 0) }}
                                                            </strong> {{-- We create the 'grand_total' CSS class to use it as a handle for AJAX inside    $('#applyCoupon').submit();    function in front/js/custom.js --}} {{-- We stored the 'couponAmount' a Session Variable inside the applyCoupon() method in Front/ProductsController.php --}}
                                                        </h3>
                                                    </td>
                                                </tr>
                                        ...
                                        <div class="u-s-m-b-13 prepaidMethod"> {{-- Paystack Payment Method --}}
                                            <input type="radio" class="radio-box" name="payment_gateway" id="paystack" value="paystack">
                                            <label class="label-text" for="paystack">Paystack</label>
                                        </div>
