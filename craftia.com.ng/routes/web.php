...
Route::namespace('App\Http\Controllers\Front')->group(function() {
    ...
    Route::get('user/sign-in', ['as' => 'login', 'uses' => 'UserController@showLogin']); // 'as' => 'login'    is Giving this route a name 'login' route in order for the 'auth' middleware ('auth' middleware is the Authenticate.php) to redirect to the right page
    Route::get('user/get-started', ['as' => 'login', 'uses' => 'UserController@showRegister']); 
    ...
    // Render the About Us page (front/pages/about.blade.php) using GET HTTP Requests
    Route::get('about-us', 'CmsController@about');

    // Render the Terms and Conditions page (front/pages/tandc.blade.php) using GET HTTP Requests
    Route::get('t-and-c', 'CmsController@tandc');
    ...
    Route::group(['middleware' => ['auth']], function() {
        ...
        Route::post('/paystack/pay', [PaystackController::class, 'make_payment'])->name('paystack.pay');
        // Route::get('/paystack/pay', [PaystackController::class, 'make_payment'])->name('paystack.pay');
        Route::get('/paystack/success', [PaystackController::class, 'success'])->name('paystack.success');
        Route::get('/paystack/error', [PaystackController::class, 'error'])->name('paystack.error');
